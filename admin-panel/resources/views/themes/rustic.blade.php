        ...
        <div class="bg-white/60 backdrop-blur-sm border border-[#d1c2b0] px-8 py-6 rounded-xl max-w-sm w-full shadow-sm">
            ...
            @if ($tamuDariUrl)
                ...
                @if ($wedding->paket == 'premium')
                    <p class="text-[10px] text-amber-700 bg-amber-50 px-2 py-0.5 rounded-full inline-block mt-2 font-medium border border-amber-200">
            ...
            @else
                <div id="wrapper-input-nama" class="mt-1 max-w-xs mx-auto">
                    <div class="flex items-center border-b border-[#a89682] focus-within:border-[#4a3b2c] transition">
                        ...
                        <button type="button" onclick="kunciNamaTamu()" class="text-xs p-1 hover:scale-110 transition cursor-pointer" title="Kunci Nama">
                            ✔️
                        </button>
                    </div>
                    <p class="text-[10px] text-[#8c765c] mt-1.5 italic">*Klik centang atau tekan Enter untuk melihat undangan</p>
                </div>
                ...
                <div id="wrapper-nama-terkunci" class="hidden">
                    ...
                    <p class="text-[10px] text-stone-600 bg-stone-100 px-2 py-0.5 rounded-full inline-block mt-2 font-medium border border-stone-200">
                        👤 Tamu Terverifikasi
                    </p>
                </div>
            @endif
